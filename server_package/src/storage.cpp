...
///
/// \brief Создает локальное хранилище тестовых блюд и ингредиентов.
///
/// Конструктор заполняет списки ингредиентов и блюд,
/// которые могут использоваться для фильтрации и тестовой работы приложения.
///
Storage::Storage() {
    // Ингредиенты
